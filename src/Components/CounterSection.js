      ...
      <div className="relative z-10 container mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-8 text-center text-white">
        {[
          ...
          <div key={index} className="group">
            <div className="w-20 h-20 md:w-24 md:h-24 mx-auto flex items-center justify-center rounded-full bg-customBlue group-hover:bg-white border-2 border-transparent border-white group-hover:border-customBlue transition-all duration-300">
              <div className="text-white group-hover:text-customBlue group-hover:bg-transparent hover:text-white">
                {stat.icon}
              </div>
            </div>
