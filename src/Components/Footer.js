...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-r bg-customBlue text-white py-8 mx-auto">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-10 px-6">
        {/* About Us Section */}
        <div>
          <h2 className="text-xl font-bold mb-4 text-white tracking-wide">About Us</h2>
          <hr className="border-t-2 w-12 border-primaryLight mb-6" />
          <p className="leading-relaxed mb-6 text-white text-lg">
          ...
          <div className="flex space-x-7 mb-4">
            {socialIcons.map((icon, index) => (
              <Link key={index} to={icon.link} className="text-2xl text-white hover:text-primaryLight transition-transform duration-300 transform hover:scale-110">
        ...
        {/* Quick Links Section */}
        <div>
          <h2 className="text-xl font-bold mb-4 text-white tracking-wide">Quick Links</h2>
          <hr className="border-t-2 w-12 border-primaryLight mb-6" />
        ...
        <div>
          <h2 className="text-xl font-bold mb-4 text-white tracking-wide">Get In Touch</h2>
          <hr className="border-t-2 w-12 border-primaryLight mb-6" />
          <p className="text-white text-lg mb-4">Corporate Office Address:</p>
          <p className="text-white text-lg mb-4">MM Tower, Plot No 8 & 9, Udyog Vihar-IV Sec 18, Gurugram - 122017</p>
          ...
          <div className="flex items-center space-x-4 mb-4">
            ...
            <a href="mailto:cs@gudmed.in" className="text-lg text-white">
              cs@gudmed.in
            </a>
          </div>
        ...
        {/* Google Map Section */}
        <div>
          <h2 className="text-xl font-bold mb-4 text-white tracking-wide">Location</h2>
          <hr className="border-t-2 w-12 border-primaryLight mb-6" />
          <iframe
          ...
          <div className="flex flex-row items-center space-x-4 mt-2">
            ...
            <Link
              ...
              target="_blank"
              className="text-lg text-white underline hover:text-primaryLight transition-colors duration-300"
            >
              View on Google Maps
            </Link>
          </div>
      ...
      <div className="text-center mt-12 text-white font-sans text-sm opacity-85">
